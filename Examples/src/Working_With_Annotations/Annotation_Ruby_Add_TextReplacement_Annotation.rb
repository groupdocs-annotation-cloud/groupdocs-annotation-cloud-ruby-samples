...
class Working_With_Annotations
  def self.Annotation_Ruby_Add_TextReplacement_Annotation()
    ...
    puts("Expected response type is void: Text Replacement Annotation added.")
  end
end